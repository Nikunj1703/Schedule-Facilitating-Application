...
public class AllScheduleController {
    ...
    private String reviewCommentStyle = "display : none";
   // private List<AllScheduleBean> allScheduleList;
    ...
    public String getReviewCommentStyle() {
        return reviewCommentStyle;
    }

    public void setReviewCommentStyle(String reviewCommentStyle) {
        this.reviewCommentStyle = reviewCommentStyle;
    }
...
//        year = "2016";
    ...
    public String modifyExistingSchedule(){
        ...
        AllScheduleDAO aAllScheduleDAO = new AllScheduleDAOImpl();
        reviewComments = aAllScheduleDAO.findReviewCommentsFromReviewCommentTable(allScheduleId);
        if(reviewComments.length()!=0)
            this.reviewCommentStyle = "display : inline";
        if(reviewComments.length()==0)
            this.reviewCommentStyle = "display : none";
        return "";
    }
